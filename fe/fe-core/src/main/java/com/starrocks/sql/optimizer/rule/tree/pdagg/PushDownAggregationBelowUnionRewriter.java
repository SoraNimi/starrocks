 ...
 *
 * */
public class PushDownAggregationBelowUnionRewriter extends OptExpressionVisitor<OptExpression, AggregatePushDownContext> {
    ...
    public PushDownAggregationBelowUnionRewriter(TaskContext taskContext) {
